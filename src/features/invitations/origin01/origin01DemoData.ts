...
export const origin01DemoData = {
  ...
  content: {
    ...
    community: {
      eyebrow: 'La noche también la hacemos entre todos',
      heading: 'Compartamos cada instante.',
      introduction: 'Encontrá la cuenta oficial, usá el hashtag de la fiesta y sumá tus fotos al álbum compartido.',
      instagram: { enabled: true, handle: 'valentina.limen', actionLabel: 'Ver en Instagram' },
      hashtag: { enabled: true, value: '#ValeCruzaElLimen', actionLabel: 'Copiar hashtag', copiedLabel: 'Hashtag copiado' },
      album: { enabled: true, url: 'https://photos.google.com/',
        invitation: 'Después de la fiesta, subí acá las fotos y videos que quieras compartir.', actionLabel: 'Abrir álbum compartido' },
    },
    trivia: {
...
function assertOrigin01DemoData(invitation: Origin01InvitationData): void {
  ...
  const requiredContent: readonly [scene: string, value: string | readonly unknown[]][] = [
    ...
    ['community.heading', invitation.content.community.heading],
