...
export const origin01Template = {
  ...
  modules: [
    ...
    { moduleId: 'instagram', internalLabel: 'Comunidad' },
  ...
  supportedModules: ['prelude', 'hero', 'countdown', 'story', 'eventDetails', 'schedule', 'weather', 'dressCode', 'gallery', 'instagram', 'trivia', 'gifts', 'rsvp', 'closing'],
  requiredModules: ['prelude', 'hero', 'eventDetails', 'closing'],
  optionalModules: ['countdown', 'story', 'schedule', 'weather', 'dressCode', 'gallery', 'instagram', 'trivia', 'gifts', 'rsvp'],
  canonicalOrder: ['prelude', 'hero', 'countdown', 'story', 'eventDetails', 'schedule', 'weather', 'dressCode', 'gallery', 'instagram', 'trivia', 'gifts', 'rsvp', 'closing'],
