...
export const studioEditorSurfaceFields = {
  'event-operations': ['giftsAccount', 'rsvpRecipientPhone'],
  gifts: ['giftsTitle', 'giftsDescription', 'giftsNote'],
  rsvp: ['rsvpTitle', 'rsvpDescription', 'rsvpActionLabel'],
  countdown: ['countdownEyebrow', 'countdownHeading', 'countdownCompletedMessage'],
  'event-copy': ['eventDetailsEyebrow', 'eventDetailsHeading', 'eventDetailsVenueLabel',
    'eventDetailsMapActionLabel', 'eventDetailsCalendarActionLabel', 'eventDetailsCalendarDescription'],
} as const
...
export function resolveStudioActiveEditor(
  editorId: string | undefined,
  slots: StudioEditorSlots,
): ReactNode | null {
